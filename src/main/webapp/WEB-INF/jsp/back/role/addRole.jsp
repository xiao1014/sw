...
<head>
    ...
    <script src="${ctx}/static/js/back/role/addRole.js?001" type="text/javascript" charset="utf-8"></script>
</head>
<body>
<div id="container">
        ...
        <div id="content">
            <div class="content row">
                <div class="panel panel-default">
                    <div class="panel-heading" style="height: 50px;"><font style="font-size: 24px">添加角色</font></div>
                        ...
                        <div class="col-md-8">
                            <form id="roleForm" method="post">
                                <div class="row">
                                    ...
                                    <div class="form-group col-xs-4">
                                        <input type="text" name="roleCode" value="adminTest"
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-xs-10">
                                        <textarea name="description"
                                                  ...
                                                  placeholder="角色描述" class="form-control"></textarea>
                                    </div>
                                </div>

                                <div class="form-group row" style="margin: 0 auto 0 auto;">
                                    <div class="col-md-11"></div>
                                    <span class="btn btn-default col-md-1" onclick="saveRole()">提交</span>
                                </div>
                            </form>
                        </div>
                        <div class="col-md-2"></div>
